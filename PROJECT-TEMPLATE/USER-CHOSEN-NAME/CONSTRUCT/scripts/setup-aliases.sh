...
alias run-update="cd $PROJECT_DIR && ./CONSTRUCT/scripts/update-context.sh"
alias run-arch="cd $PROJECT_DIR && ./CONSTRUCT/scripts/update-architecture.sh"
alias run-check="cd $PROJECT_DIR && ./CONSTRUCT/scripts/check-architecture.sh"
alias run-quality="cd $PROJECT_DIR && ./CONSTRUCT/scripts/check-quality.sh"
alias run-accessibility="cd $PROJECT_DIR && ./CONSTRUCT/scripts/check-accessibility.sh"
alias run-before="cd $PROJECT_DIR && ./CONSTRUCT/scripts/before_coding.sh"
alias run-scan="cd $PROJECT_DIR && ./CONSTRUCT/scripts/scan_mvvm_structure.sh"
alias run-claude="cd $PROJECT_DIR && code CLAUDE.md"
alias run-full="cd $PROJECT_DIR && ./CONSTRUCT/scripts/update-context.sh && ./CONSTRUCT/scripts/update-architecture.sh && ./CONSTRUCT/scripts/check-quality.sh && ./CONSTRUCT/scripts/check-accessibility.sh"
alias run-session-summary="cd $PROJECT_DIR && ./CONSTRUCT/scripts/session-summary.sh"
