...
alias run-update="cd $PROJECT_DIR && ./CONSTUCT/scripts/update-context.sh"
alias run-arch="cd $PROJECT_DIR && ./CONSTUCT/scripts/update-architecture.sh"
alias run-check="cd $PROJECT_DIR && ./CONSTUCT/scripts/check-architecture.sh"
alias run-quality="cd $PROJECT_DIR && ./CONSTUCT/scripts/check-quality.sh"
alias run-accessibility="cd $PROJECT_DIR && ./CONSTUCT/scripts/check-accessibility.sh"
alias run-before="cd $PROJECT_DIR && ./CONSTUCT/scripts/before_coding.sh"
alias run-scan="cd $PROJECT_DIR && ./CONSTUCT/scripts/scan_mvvm_structure.sh"
alias run-claude="cd $PROJECT_DIR && code CLAUDE.md"
alias run-full="cd $PROJECT_DIR && ./CONSTUCT/scripts/update-context.sh && ./CONSTUCT/scripts/update-architecture.sh && ./CONSTUCT/scripts/check-quality.sh && ./CONSTUCT/scripts/check-accessibility.sh"
alias run-session-summary="cd $PROJECT_DIR && ./CONSTUCT/scripts/session-summary.sh"
