...
add_construct_aliases() {
    ...
    echo "alias construct-claude='cd \"$CONSTRUCT_ROOT\" && code CONSTRUCT-dev/AI/CLAUDE.md'" >> "$SHELL_CONFIG"
    echo "alias construct-todo='cd \"$CONSTRUCT_ROOT\" && ls CONSTRUCT-dev/AI/todo/'" >> "$SHELL_CONFIG"
    echo "alias construct-logs='cd \"$CONSTRUCT_ROOT\" && ls CONSTRUCT-dev/AI/dev-logs/dev-udpates/'" >> "$SHELL_CONFIG"
    echo "" >> "$SHELL_CONFIG"
...
show_aliases() {
    ...
    echo "  cd-construct-dev       # Go to CONSTRUCT-dev/"
