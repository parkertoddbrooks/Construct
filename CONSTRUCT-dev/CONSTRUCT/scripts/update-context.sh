...
- CONSTRUCT-dev/CONSTRUCT/scripts/ - Core development scripts
- CONSTRUCT-dev/CONSTRUCT/lib/ - Shared library functions  
- CONSTRUCT-dev/AI/docs/automated/ - Auto-generated documentation
