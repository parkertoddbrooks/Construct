...
add_construct_aliases() {
    ...
    echo "alias cd-construct-lib='cd \"$CONSTUCT_DEV/lib\"'" >> "$SHELL_CONFIG"
    echo "alias cd-construct-config='cd \"$CONSTUCT_DEV/config\"'" >> "$SHELL_CONFIG"
    echo "" >> "$SHELL_CONFIG"
    
    # User project aliases (for template testing)
    echo "# User Project Development (Template Testing)" >> "$SHELL_CONFIG"
    echo "alias construct-user-update='cd \"$CONSTRUCT_ROOT/USER-project-files\" && ./AI/scripts/update-context.sh'" >> "$SHELL_CONFIG"
    echo "alias construct-user-check='cd \"$CONSTRUCT_ROOT/USER-project-files\" && ./AI/scripts/check-architecture.sh'" >> "$SHELL_CONFIG"
    echo "alias construct-user-quality='cd \"$CONSTRUCT_ROOT/USER-project-files\" && ./AI/scripts/check-quality.sh'" >> "$SHELL_CONFIG"
    echo "alias construct-user-before='cd \"$CONSTRUCT_ROOT/USER-project-files\" && ./AI/scripts/before_coding.sh'" >> "$SHELL_CONFIG"
    echo "alias construct-user-scan='cd \"$CONSTRUCT_ROOT/USER-project-files\" && ./AI/scripts/scan_mvvm_structure.sh'" >> "$SHELL_CONFIG"
    echo "alias construct-user-access='cd \"$CONSTRUCT_ROOT/USER-project-files\" && ./AI/scripts/check-accessibility.sh'" >> "$SHELL_CONFIG"
    echo "" >> "$SHELL_CONFIG"
